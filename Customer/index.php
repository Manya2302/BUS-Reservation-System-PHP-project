...
<a class="navbar-brand" href="index.html">A<span class="themecolor">M</span>BUS</a>
...
<li><a href="profile.php" class="page-scroll"><h3>Profile</h3></a></li>
...
<h1 class="main-heading-title"><span class="main-element themecolor" data-elements=" AM BUS Online, AM BUS Online, AM BUS Online"></span></h1>
...
<p class="main-heading-text">Through the beauty of the world on wheels – book your bus journey online.</p>
...
<p class="a-slog"> In public transport, e-ticketing systems are not only means of
...
structure that are not easy to implement with traditional payment tools. </p> 
...
<p class="black">Among other benefits, flexibility moderates demand on the energy system, reducing the generation capacity required to meet demand, and avoiding building excess generation which sits idle in back up for those times when our electricity demand is at its greatest.</p>
...
<p class="black">A fully responsive website will rescale itself to preserve the user experience and look and feel across all devices — with no irritating zooming, scrolling or resizing.
</p>
...
<p class="black">Learn About How to Monetize a Blog. See How You Can Implement these Methods on Your Blog. See How Successful Blogs Earn their Money and the Top Ways You Can Do the Same! Mobile optimized. Free multilingual fonts. Traffic generation tools.</p>
