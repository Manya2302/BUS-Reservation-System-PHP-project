...
<?php include "header.php"; ?>
    ...
    <div class="container" style="width: 50%;">
        ...
        <img src="../Admin/admin/images/<?php echo $image;?>" width="200" style="margin-left: 32%;" class="img-circle" alt="Profile"> 
        <br><br><br><br>
        <div class="tab">
        ...
        <div id="Personel Details" class="tabcontent">
          ...
          //echo $curr_user_id;
          $query = "SELECT * FROM admin_users where user_id = $curr_user_id";
...
<br><br><br>
        ...
        <div id="Edit Details" class="tabcontent">
          ...
          <?php
            ...
            while($row = mysqli_fetch_assoc($select_admin_users)) {
                $username = $row['username'];
            ...
            if (isset($_POST['update-user'])) {
              ...
              $query = "UPDATE admin_users SET username='{$username}', user_password='{$user_password}', user_firstname='{$user_firstname}', user_lastname='{$user_lastname}', user_password='{$user_password}', user_phoneno={$user_phoneno}, user_email='{$user_email}', user_image='{$image}' WHERE user_id=$curr_user_id";
