...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">AM BUS Online Ticketing</a>
    </div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			<i>AM BUS Transport, M/V Lady of All Nations</i>
			 			<h3>
			 ...
			 <div class="panel panel-success">
				...
				PASSENGERS</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						   ...
						   <center>
							<img src="./images/Screenshot_20230625_135435_Paytm.jpg" height="500px" width="500px"></img>
							   <br><br><a href="index.php" class="btn btn-success" onclick="returnHome()">Return Home
...
<script type="text/javascript">
	function returnHome() {
		alert("Thank you for your payment! Your ticket PDF will be sent to your email if the transaction is successful.");
		return true;
	}
</script>
