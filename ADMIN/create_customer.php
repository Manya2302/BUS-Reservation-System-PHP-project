...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function createCustomer($username, $password, $firstName, $lastName, $email, $phoneNumber, $gender, $age) {
        ...
        $query = "INSERT INTO users (username, password, firstname, lastname, email, phonenumber, gender, age, role) VALUES (:username, :password, :firstName, :lastName, :email, :phoneNumber, :gender, :age, 'customer')";
    ...
    createCustomer($username, $password, $firstName, $lastName, $email, $phoneNumber, $gender, $age);
