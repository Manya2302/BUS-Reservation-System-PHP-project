...
$query = "SELECT *  FROM  admin_users WHERE user_id=$edit_user_id";
...
if (isset($_POST['update-user'])) {
	...
	$query = "UPDATE admin_users SET user_firstname = '$user_firstname', user_lastname = '$user_lastname' , user_image='$image' WHERE user_id=$edit_user_id ";
